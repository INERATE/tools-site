...
export function Hero() {
  return (
    ...
    >
      <span className="glass rounded-full px-4 py-1.5 text-[11px] font-semibold tracking-[0.16em] text-[#25be74] uppercase">
        Free, Private, Browser-Based
      </span>
      <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] font-semibold tracking-[-0.02em]">
        Document tools that <span className="font-normal text-[#25be74] italic">just work</span>
      </h1>
      <p className="max-w-lg text-lg leading-relaxed text-[#9b9b98]">
