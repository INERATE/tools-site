...
/** Text lines fade out while a "#" heading mark draws in beside a shortened line. */
export function PdfToMarkdownIcon(p: IconProps) {
  return (
    <IconShell {...p}>
      ...
      />
      <motion.path
        d="M8.5 8v3.5M6.7 9h3.6M6.7 10.7h3.6"
