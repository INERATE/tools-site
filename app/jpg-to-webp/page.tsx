...
/** Same engine as /convert-image, locked to WEBP output — SEO-templated landing page for the "jpg to webp" query. */
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 pt-28 pb-16">
        <ToolHead
          ...
          blurb="Turn JPG images into the smaller WEBP format. Nothing is uploaded — conversion happens entirely in your browser."
        />

        <div className="grid gap-6 lg:grid-cols-[1fr_280px] lg:items-start lg:gap-8">
          <ToolWindow path="jpg-to-webp">
            <Dropzone
              id="jpg-to-webp-input"
              multiple
              accept="image/jpeg"
              onFiles={c.addFiles}
