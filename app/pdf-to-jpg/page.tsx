...
/** Same engine as /pdf-to-image, defaulted to JPEG — SEO-templated landing page for the "pdf to jpg" query. */
export default function PdfToJpgPage() {
  const { board, r, base, ext, step, count, edit, thumb } = usePdfToJpg();
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 pt-28 pb-16">
        <ToolHead
          ...
          blurb="Export pages as JPG. Drop the pages you do not want, rotate the ones you do, then convert — rendering happens in your browser and nothing is uploaded."
        />

        <div className="grid gap-6 lg:grid-cols-[1fr_280px] lg:items-start lg:gap-8">
          <ToolWindow path="pdf-to-jpg">
            <Dropzone
              id="to-jpg-input"
