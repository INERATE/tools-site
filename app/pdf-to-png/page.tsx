...
import { ConvertAction } from "../pdf-to-image/convert-action";
import { PageGrid } from "../pdf-to-image/page-grid";
import { RenderOptions } from "../pdf-to-image/render-options";
import { usePdfToPng } from "./use-pdf-to-png";
import { STEPS } from "./pipeline-steps";

/** Same engine as /pdf-to-image, defaulted to PNG — SEO-templated landing page for the "pdf to png" query. */
export default function PdfToPngPage() {
  const { board, r, base, ext, step, count, edit, thumb } = usePdfToPng();
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 pt-28 pb-16">
        <ToolHead
          ...
          blurb="Export pages as PNG. Drop the pages you do not want, rotate the ones you do, then convert — rendering happens in your browser and nothing is uploaded."
        />

        <div className="grid gap-6 lg:grid-cols-[1fr_280px] lg:items-start lg:gap-8">
          <ToolWindow path="pdf-to-png">
            <Dropzone
              id="to-png-input"
