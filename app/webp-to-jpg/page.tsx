...
/** Same engine as /convert-image, locked to JPG output — SEO-templated landing page for the "webp to jpg" query. */
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 pt-28 pb-16">
        <ToolHead
          ...
          blurb="Turn WEBP images into JPG. Nothing is uploaded — conversion happens entirely in your browser."
        />

        <div className="grid gap-6 lg:grid-cols-[1fr_280px] lg:items-start lg:gap-8">
          <ToolWindow path="webp-to-jpg">
            <Dropzone
              id="webp-to-jpg-input"
              multiple
              accept="image/webp"
              onFiles={c.addFiles}
